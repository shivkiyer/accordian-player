export const MAX_VIDEO_PLAYER_WIDTH = 1080; // px
export const VIDEO_PLAYER_ASPECT_RATIO = 0.5625; // 9:16 - height:width
...
export const CONTROL_BAR_HEIGHT_SMALL = 64; // Control bar height for 630px width

// Progress bar settings

export const PROGRESS_BAR_CONTAINER_HEIGHT_LARGE = 24;
export const PROGRESS_BAR_CONTAINER_HEIGHT_SMALL = 15.75;
export const PROGRESS_BAR_HEIGHT_LARGE = 5; // Progress bar height for 1920px width
export const PROGRESS_BAR_HEIGHT_SMALL = 3; // Progress bar height for 630px width
// Progress bar margin from sides of control bar for 1920px
export const PROGRESS_BAR_MARGIN_SIDE_LARGE = 24;
// Progress bar margin from sides of control bar for 630px
export const PROGRESS_BAR_MARGIN_SIDE_SMALL = 15.75;

// Left control buttons settings

export const LEFT_BUTTONS_LEFT_MARGIN_LARGE = 24;
export const LEFT_BUTTONS_LEFT_MARGIN_SMALL = 15.75;
export const LEFT_BUTTONS_HEIGHT_LARGE = 72;
export const LEFT_BUTTONS_HEIGHT_SMALL = 47.25;
export const LEFT_BUTTONS_WIDTH_LARGE = 48;
export const LEFT_BUTTONS_WIDTH_SMALL = 31.5;
export const LEFT_BUTTON_LEFT_MARGIN_LARGE = 24;
export const LEFT_BUTTON_LEFT_MARGIN_SMALL = 15.75;
...
export const FULLSCREEN_BTN_HEIGHT_LARGE = 30;
...
export const SELECT_PANEL_SIDE_MARGIN_LARGE = 120;
export const SELECT_PANEL_SIDE_MARGIN_SMALL = 78.75;

// Selection panel heading
export const SELECT_PANEL_HEADING_HEIGHT_LARGE = 48;
export const SELECT_PANEL_HEADING_HEIGHT_SMALL = 31.5;
export const SELECT_PANEL_HEADING_FONT_LARGE = 38;
export const SELECT_PANEL_HEADING_FONT_SMALL = 14;

// Selection table

export const SELECT_TABLE_TOP_MARGIN_LARGE = 24;
export const SELECT_TABLE_TOP_MARGIN_SMALL = 15.75;

export const SELECT_TABLE_PADDING_LARGE = 6;
export const SELECT_TABLE_PADDING_SMALL = 3.9375;

export const SELECT_PANEL_ROW_HEIGHT_LARGE = 36;
export const SELECT_PANEL_ROW_HEIGHT_SMALL = 23.625;
export const SELECT_PANEL_ROW_MARGIN_LARGE = 12;
export const SELECT_PANEL_ROW_MARGIN_SMALL = 7.875;

export const SELECT_PANEL_COLUMN_WIDTH_LARGE = 144;
export const SELECT_PANEL_COLUMN_WIDTH_SMALL = 94;
export const SELECT_PANEL_COLUMN_MARGIN_LARGE = 6;
export const SELECT_PANEL_COLUMN_MARGIN_SMALL = 3.9375;

export const SELECT_TABLE_FONT_LARGE = 20;
export const SELECT_TABLE_FONT_SMALL = 12;

export const SELECT_TABLE_TITLE_LEFT_PADDING_LARGE = 6;
export const SELECT_TABLE_TITLE_LEFT_PADDING_SMALL = 3.9375;

export const SELECT_TABLE_RADIO_BTN_LARGE = 14;
export const SELECT_TABLE_RADIO_BTN_SMALL = 9;

// Continue button

export const CONTINUE_BTN_WIDTH_LARGE = 288;
export const CONTINUE_BTN_WIDTH_SMALL = 189;

export const CONTINUE_BTN_HEIGHT_LARGE = 60;
export const CONTINUE_BTN_HEIGHT_SMALL = 39.375;
